...
public class Metodos {
	...
	public class Libro {
	    ...
	    private LocalDate Fecha; // Cambiado a tipo Date
	   ...
	   public Libro() {
	    ...
	    public Libro(String titulo, Long isbn, String autor, String editorial, LocalDate fecha, Ficheros.Categoria categoria,
